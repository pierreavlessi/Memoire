...
.page-item.active .page-link, .page-item.active .page-link:hover, .page-item.active .page-link:focus, .pagination li.active > a:not(.page-link), .pagination li.active > a:not(.page-link):hover, .pagination li.active > a:not(.page-link):focus {
    ...
    <div class="layout-content">
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            <h4 class="font-weight-bold py-3 mb-0">Enregistrer le type d'activité</h4>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card ">
                        <h6 class="card-header"><i class="feather icon-home"></i> Ajouter un type d'activité</h6>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                      <h6 class="card-header"><i class="feather icon-user"></i> Types des Activités </h6>
