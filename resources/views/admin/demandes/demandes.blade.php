                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="demande" action="{{ route('demandes/save') }}" method="POST" class="col-sm-12">
                            ...
                            <input type="hidden" id="hiddenMontant" name="initialMontant" value="<?php echo $initialMontant; ?>">
                            <!-- Champ caché pour le montant -->
                            <div class="form-group row">
                                <label class="col-form-label text-sm-right">Numéro</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="profil" value="{{ $code }}"
                                        readonly style="text-transform: uppercase;" name="numero" placeholder="numero"
                                        required>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label  text-sm-right">Pieces</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label  text-sm-right">Montant</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="montant_total"
                                        style="text-transform: uppercase;" name="montant" value="" readonly
                            ...
                            <button type="button" id="paiementEnLigneBtn"
                                class="mx-auto btn btn-primary  text-center">Envoyer</button>
                        </form>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        ...
        pieceSelect.addEventListener('change', function() {
            ...
            if (selectedPiece) {
                montantInput.value = selectedPiece
                    .montant; // Met à jour le champ de montant avec le montant de la pièce sélectionnée
                ...
                FedaPay.init('#paiementEnLigneBtn', {
                    ...
                    //public_key: 'pk_live_Y3n5A2awAbaRB0CwLPPHOBrT',
                    public_key: 'pk_live_HoS2XUan3Kw0gFGPEpKF7MNN',
                    transaction: {
