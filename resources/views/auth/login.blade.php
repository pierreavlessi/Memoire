                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class=" font-weight-bold">
                                        <h3 class="text-center">Application WEB GESTSALLE</h3>
                                       
                                        <p class="text-justify">Veuillez vous connecter pour accéder aux fonctionnalités avancées de gestion des salles de cours de l'ENA</p>
